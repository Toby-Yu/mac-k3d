...
mod tests {
    ...
    fn jenkins_job_eval_fields_roundtrip() {
        ...
        cfg.jenkins_job.default_deepseek_model = "deepseek-flash".into();
        ...
        assert!(yaml.contains("default_deepseek_model: deepseek-flash"));
        ...
        assert_eq!(
            exported.jenkins_job.default_deepseek_model,
            "deepseek-flash"
        );
